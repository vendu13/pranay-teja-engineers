...
app.post('/projects/delete', loadAuthorizeUser, ProjectsController.deleteProject)
app.post('/projects/create/gallery', loadAuthorizeUser, upload.array('images'), checkPath, ProjectsController.setGallery)
app.post('/projects/create/main', loadAuthorizeUser, upload.single('images'), checkPathMain, ProjectsController.setMain)
